...
export default function ReserverPage() {
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Réserver une soirée</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Liste des soirées */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold mb-4">Soirées réservées</h2>
                  ...
                  return (
                    <div key={soiree.id} className="border rounded p-4">
                      <div className="flex justify-between items-start mb-2">
                        <h3 className="font-semibold">{soiree.lieu}</h3>
